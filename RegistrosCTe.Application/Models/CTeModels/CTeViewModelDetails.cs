...
namespace RegistrosCTe.Application.Models.CTeModels
{
    ...
    {
        public CTeViewModelDetails(decimal valorCTe, decimal iCMS, DateTime dataEmissao, Viagem viagem)
        {
            ValorCTe = valorCTe;
            ICMS = iCMS;
            DataEmissao = dataEmissao;
            Viagem = ViagemViewModelDetails.FromEntity(viagem);
        }
        ...
        public static CTeViewModelDetails FromEntity(CTe CTe)
            => new(CTe.ValorCTe, CTe.ValorICMS, CTe.DataEmissao,CTe.Viagem);
    }
}
